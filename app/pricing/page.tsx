      ...
      <section className="relative pt-32 md:pt-40 pb-16">
        ...
        <div className="container-narrow relative">
          ...
          <p className="mt-7 max-w-2xl text-[17px] md:text-[19px] text-steel-300 leading-relaxed">
            ...
            <span className="text-steel-100 font-semibold">$0 down at $349/mo</span>{" "}
        ...
        <div className="container-narrow">
          <div className="mb-10">
            ...
            <p className="mt-3 max-w-xl text-[15px] text-steel-300 leading-relaxed">
              ...
              AI-native site for <span className="text-steel-100 font-semibold">$0 down</span>, then host, secure, and
              maintain it for one flat monthly price. It's the way most small
              businesses launch with us.
            </p>
          </div>

          <div className="glass rounded-3xl border border-tide-500/40 shadow-glow p-8 md:p-10">
            <div className="grid lg:grid-cols-[1fr_1.1fr] gap-8 lg:gap-12">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="font-display font-semibold text-[56px] md:text-[64px] text-steel-100 leading-none">
                    $349
                  </span>
                  <span className="text-[16px] text-steel-400">/ mo</span>
                </div>
                <p className="mt-3 text-[14px] text-tide-300 font-medium">
              ...
              <div className="flex flex-col gap-8 lg:border-l lg:border-white/10 lg:pl-12">
                <div>
                  <h4 className="text-[12px] uppercase tracking-widest font-semibold text-steel-400 mb-4">
                    Everything's included
                  </h4>
                  <ul className="space-y-2.5 text-[13px] text-steel-300 leading-relaxed">
                    {waasIncludes.map((f) => (
                ...
                <div>
                  ...
                  <ol className="space-y-3 text-[13px] text-steel-300 leading-relaxed">
                    {waasSteps.map((s, i) => (
